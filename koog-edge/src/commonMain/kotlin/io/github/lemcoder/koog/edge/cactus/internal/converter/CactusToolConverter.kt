...
internal val koogToCactusToolConverter =
    Converter<ToolDescriptor, CactusTool> { tool ->
        val requiredParameters =
            tool.requiredParameters.map(koogToCactusRequiredParameterConverter::convert)
        val optionalParameters =
            tool.optionalParameters.map(koogToCactusOptionalParameterConverter::convert)
...
private val koogToCactusParameterTypeConverter =
    Converter<ToolParameterType, String> { type -> type.name.lowercase() }
